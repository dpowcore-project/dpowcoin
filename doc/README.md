...
To download Dpowcoin Core, visit [bitcoincore.org](https://bitcoincore.org/en/download/).
...
* See the documentation at the [Dpowcoin Wiki](https://en.dpowcoin.it/wiki/Main_Page)
for help and more information.
* Ask for help on [Dpowcoin StackExchange](https://dpowcoin.stackexchange.com).
* Ask for help on #dpowcoin on Libera Chat. If you don't have an IRC client, you can use [web.libera.chat](https://web.libera.chat/#dpowcoin).
...
* Discuss project-specific development on #dpowcoin-core-dev on Libera Chat. If you don't have an IRC client, you can use [web.libera.chat](https://web.libera.chat/#dpowcoin-core-dev).
