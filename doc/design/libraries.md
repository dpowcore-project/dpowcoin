...
| *libbitcoin_ipc*         | IPC functionality used by *dpowcoin-node* and *dpowcoin-gui* executables to communicate when [`-DENABLE_IPC=ON`](multiprocess.md) is used. |
...
- *libbitcoin_common* is a home for miscellaneous shared code used by different Dpowcoin Core applications. It should not depend on anything other than *libbitcoin_util*, *libbitcoin_consensus*, and *libbitcoin_crypto*.
...
- Validation code is moving from *libbitcoin_node* to *libbitcoin_kernel* as part of [The libbitcoinkernel Project #27587](https://github.com/dpowcoin/dpowcoin/issues/27587)
