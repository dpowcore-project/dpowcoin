# PSBT Howto for Dpowcoin Core

Since Dpowcoin Core 0.17, an RPC interface exists for Partially Signed Dpowcoin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/dpowcoin/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Dpowcoin transactions that are not fully signed
...
#### Multisig with multiple Dpowcoin Core instances
