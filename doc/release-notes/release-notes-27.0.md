Dpowcoin Core version 27.0 is now available from:

  <https://bitcoincore.org/bin/dpowcoin-core-27.0/>
...
- A C++20 capable compiler is now required to build Dpowcoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Dpowcoin Core would
