Dpowcoin Core version 29.1 is now available from:

  <https://bitcoincore.org/bin/dpowcoin-core-29.1/>
...
- #32679 doc: update tor docs to use dpowcoind binary from path
...
- #32719 doc, windows: CompanyName "Dpowcoin" => "Dpowcoin Core project"
...
[Transifex](https://explore.transifex.com/dpowcoin/dpowcoin/).
