Dpowcoin Core version 0.13.2 is now available from:

  <https://dpowcoin.org/bin/dpowcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update dpowcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow dpowcoin-tx to create v2 transactions (btcdrak)
