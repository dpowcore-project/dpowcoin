Dpowcoin Core version 0.13.1 is now available from:

  <https://dpowcoin.org/bin/dpowcoin-core-0.13.1/>
...
- **Elimination of unwanted transaction malleability:** Segregating the witness
  ...
  malleability, which is a problem that makes programming Dpowcoin wallet
  software more difficult and which seriously complicates the design of smart
  contracts for Dpowcoin.
...
- **Weighting data based on how it affects node performance:** Some parts of
  each Dpowcoin block need to be stored by nodes in order to validate future
...
- **Increased security for multisig:** Dpowcoin addresses (both P2PKH addresses
  ...
  believed to be provided by Dpowcoin's choice of parameters for its Elliptic
  Curve Digital Security Algorithm [ECDSA].)

- **More efficient almost-full-node security** Satoshi Nakamoto's original
  Dpowcoin paper describes a method for allowing newly-started full nodes to
  skip downloading and validating some data from historic blocks that are
  protected by large amounts of proof of work.  Unfortunately, Nakamoto's
  method can't guarantee that a newly-started node using this method will
  produce an accurate copy of Dpowcoin's current ledger (called the UTXO set),
  ...
  note that Dpowcoin Core does not provide an option to use this capability as
  of this 0.13.1 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  Dpowcoin users to individually opt-in to almost any change in the Dpowcoin
  Script language when those users receive new transactions.  Features
  currently being researched by Dpowcoin Core contributors that may use this
  capability include support for Schnorr signatures, which can improve the
  privacy and efficiency of multisig transactions (or transactions with
  multiple inputs), and Merklized Abstract Syntax Trees (MAST), which can
  improve the privacy and efficiency of scripts with two or more conditions.
  Other Dpowcoin community members are studying several other improvements
...
[BIP141]: https://github.com/dpowcoin/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/dpowcoin/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/dpowcoin/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/dpowcoin/bips/blob/master/bip-0145.mediawiki
...
Since Dpowcoin Core 0.10.0, nodes have defaulted to only relaying and
...
[BIP147]: https://github.com/dpowcoin/bips/blob/master/bip-0147.mediawiki
...
- #8829 `2a8bca4` Add dpowcoin-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` dpowcoin-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_dpowcoinds() into stop_nodes() (MarcoFalke)
...
- #8683 `8a7d7ff` Fix incorrect file name dpowcoin.qrc  (bitcoinsSG)
...
- #8817 `bcf3806` update dpowcoin-tx to output witness data (jnewbery)
