Dpowcoin Core version 0.10.4 is now available from:

  <https://dpowcoin.org/bin/dpowcoin-core-0.10.4/>
...
- #6953 `43c2789` Split dpowcoin-tx into its own package
- #6953 `dfe0d4d` Include dpowcoin-tx binary on Debian/Ubuntu
