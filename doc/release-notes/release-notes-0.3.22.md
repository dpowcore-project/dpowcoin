Download URL: https://sourceforge.net/projects/dpowcoin/files/Dpowcoin/dpowcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 DPC fee schedule (users still pay 0.01 DPC per kb, until next version)
