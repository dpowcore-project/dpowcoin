Dpowcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/dpowcoin/files/Dpowcoin/dpowcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Dpowcoin
...
New/changed settings (command-line or dpowcoin.conf file)
--------------------------------------------------------
