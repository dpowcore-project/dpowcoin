Dpowcoin Core version 0.9.2.1 is now available from:

  https://dpowcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 DPC to 0.01 DPC
...
- Fix "Start dpowcoin on system login"
