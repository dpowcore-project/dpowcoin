Dpowcoin Core version 0.9.4 is now available from:

  https://dpowcoin.org/bin/0.9.4/
...
this update is incompatible with the Dpowcoin system and could lead to consensus
forks.

Dpowcoin Core released binaries from https://dpowcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~dpowcoin/+archive/ubuntu/dpowcoin
- A third-party or self-compiled Dpowcoin Core

upgrade to Dpowcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
