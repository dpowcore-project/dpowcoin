...
The project's collection of seed corpora is found in the [`dpowcore-project/qa-assets`](https://github.com/dpowcore-project/qa-assets) repo.

To fuzz `process_message` using the [`dpowcore-project/qa-assets`](https://github.com/dpowcore-project/qa-assets) seed corpus:

```sh
$ git clone --depth=1 https://github.com/dpowcore-project/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`dpowcore-project/qa-assets`](https://github.com/dpowcore-project/qa-assets) repo.

Every single pull request submitted against the Dpowcoin Core repo is automatically tested against all inputs in the [`dpowcore-project/qa-assets`](https://github.com/dpowcore-project/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Dpowcoin Core more robust.
