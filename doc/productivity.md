...
```sh
cmake --build build --target dpowcoind dpowcoin-cli
cmake --build build --target dpowcoin-qt
...
[remote "upstream-pull"]
        ...
        url = git@github.com:dpowcoin/dpowcoin.git
```
...
> e.g. github.com/dpowcoin/dpowcoin.git or for the GUI github.com/dpowcoin-core/gui
