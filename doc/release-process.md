...
* Update dpowcoin.conf and commit changes if they exist, see [gen-bitcoin-conf.sh](/contrib/devtools/README.md#gen-bitcoin-confsh).
...
- Prune inputs from the qa-assets repo (See [pruning
  inputs](https://github.com/dpowcore-project/qa-assets#pruning-inputs)).

#### Before final release

- Ensure the "Needs release note" label is removed from all relevant pull
  requests and issues:
  https://github.com/dpowcore-project/dpowcoin/issues?q=label%3A%22Needs+release+note%22

#### Tagging a release (candidate)

To tag the version (or release candidate) in git, use the `make-tag.py` script from [dpowcoin-maintainer-tools](https://github.com/dpowcore-project/dpowcoin-maintainer-tools). From the root of the repository run:
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/dpowcore-project/guix.sigs.git
...
Then open a Pull Request to the [guix.sigs repository](https://github.com/dpowcore-project/guix.sigs).
...
- Upload to the dpowcore.org server:
...
- After uploading release candidate binaries, notify the
  [Dpowcoin Discord](https://discord.gg/b9zkzAgUpH) and
  [Dpowcoin Telegram](https://t.me/dpowcoin) that a release candidate is available for testing.
...
- Optionally help seed this torrent. To get the `magnet:` URI use:
  ...
  people without access to `dpowcore.org` to download the binary distribution.
...
- Update the dpowcore.org website

  - RPC documentation update

      - https://github.com/dpowcore-project/dpowcore.org/tree/main/contrib/doc-gen
...
- Announce the release:
  ...
  - Dpowcoin Core release list https://dpowcore.org/en/blog/

  - Dpowcoin Core X https://x.com/dpowcoin

  - Dpowcoin Core Telegram https://t.me/dpowcoinnews
