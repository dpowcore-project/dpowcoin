...
{
    BOOST_CHECK(TestSplitHost("www.dpowcore.org", "www.dpowcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.dpowcore.org]", "www.dpowcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.dpowcore.org:80", "www.dpowcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.dpowcore.org]:80", "www.dpowcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.dpowcore.org:65536", "www.dpowcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.dpowcore.org:0", "www.dpowcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.dpowcore.org:", "www.dpowcore.org:", 0, false));
}
