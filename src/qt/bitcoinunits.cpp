...
{
    switch (unit) {
    case Unit::BTC: return QString("DPC");
    case Unit::mBTC: return QString("mDPC");
    case Unit::uBTC: return QString::fromUtf8("µDPC (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Dpowcoins");
    case Unit::mBTC: return QString("Milli-Dpowcoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Dpowcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
