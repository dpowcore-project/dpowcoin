// Copyright (c) 2011-present The Dpowcoin Core developers
...
/** Call node.updateRwSetting() with Dpowcoin 22.x workaround. */
static void UpdateRwSetting(interfaces::Node& node, OptionsModel::OptionID option, const std::string& suffix, const common::SettingsValue& value)
{
    if (value.isNum() &&
        ...
        // because Dpowcoin 22.x releases try to read these specific settings as
        ...
        // in later releases by https://github.com/dpowcoin/dpowcoin/pull/24498.
        // If new numeric settings are added, they can be written as numbers
        // instead of strings, because dpowcoin 22.x will not try to read these.
...
void OptionsModel::checkAndMigrate()
{
    ...
    if (settingsVersion < CLIENT_VERSION)
    {
        ...
        // see https://github.com/dpowcoin/dpowcoin/pull/8273
    ...
    // (https://github.com/dpowcoin-core/gui/issues/567).
