...
complete --command dpowcoind --no-files

# Extract options
function __fish_dpowcoind_get_options
...
complete \
    --command dpowcoind \
    --arguments "(__fish_dpowcoind_get_options --nofiles)"
