...
# Extract options
function __fish_dpowcoin_tx_get_options
...
# Extract commands
function __fish_dpowcoin_tx_get_commands
...
complete \
    --command dpowcoin-tx \
    --condition "not __fish_dpowcoin_seen_cmd (__fish_dpowcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_dpowcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command dpowcoin-tx \
    --arguments "(__fish_dpowcoin_tx_get_commands)" \
    --no-files
