...
complete --command dpowcoin-qt --no-files

# Extract options
function __fish_dpowcoinqt_get_options
...
complete \
    --command dpowcoin-qt \
    --arguments "(__fish_dpowcoinqt_get_options --nofiles)"
