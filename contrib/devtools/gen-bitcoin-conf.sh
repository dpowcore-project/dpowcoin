...
BITCOIND=${BITCOIND:-$BINDIR/dpowcoind}
...
then
  ...
  echo -e "To safely generate a dpowcoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi
