...
The input UTXO set can be generated by Dpowcoin Core with the `dumptxoutset` RPC:
$ dpowcoin-cli dumptxoutset ~/utxos.dat latest
...
UTXO_DUMP_VERSION = 2
NET_MAGIC_BYTES = {
    b"\xf2\x9f\x4a\xfb": "Mainnet",
    b"\xea\x64\xee\x7f": "Signet",
    b"\x3c\xda\x0b\xe8": "Testnet3",
    b"\x3c\x52\xdc\xf5": "Testnet4",
    b"\xaf\xc0\x0c\x2e": "Regtest",
}
