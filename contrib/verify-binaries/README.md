...
As of Dpowcoin Core v30.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/dpowcore-project/guix.sigs/). When
...
builder-keys](https://github.com/dpowcore-project/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://dpowcore.org or release tag.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/dpowcoin-30.0-x86_64-linux-gnu.tar.gz \
    ~/Downloads/dpowcoin-30.0-arm-linux-gnueabihf.tar.gz
```
