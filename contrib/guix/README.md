...
This directory contains the files necessary to perform bootstrappable Dpowcoin
Core builds.
...
```
env DETACHED_SIGS_REPO=<path/to/dpowcoin-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/dpowcore-project/guix.sigs).
