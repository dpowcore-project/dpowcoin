...
def main():
    ...
    enable_dpowcoind = config["components"].getboolean("ENABLE_BITCOIND")

    if not enable_dpowcoind:
...
def run_tests(*, test_list, build_dir, tmpdir, jobs=1, enable_coverage=False, args=None, combined_logs_len=0, failfast=False, use_term_control, results_filepath=None):
    ...
    # a hard link or a copy on any platform. See https://github.com/dpowcoin/dpowcoin/pull/27561.
