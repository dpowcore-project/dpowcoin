#!/usr/bin/env python3
# Copyright (c) 2017-2022 The Dpowcoin Core developers
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"dpowcoin-cli -h\" for help or \"dpowcoin-cli listwallets\" to see "
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Prevent dpowcoin-cli from using existing rpcport in conf
