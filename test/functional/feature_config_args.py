...
class ConfArgsTest(BitcoinTestFramework):
    ...
    def test_dir_config(self):
        ...
        conf_path = self.nodes[0].datadir_path / 'dpowcoin.conf'
    ...
    def test_negated_config(self):
        ...
        ignored_file_message = [f'Data directory "{self.nodes[0].datadir_path}" contains a "dpowcoin.conf" file which is explicitly ignored using -noconf.']
    ...
    def test_config_file_parser(self):
        ...
        with open(self.nodes[0].datadir_path / 'dpowcoin.conf', 'a') as conf:
    ...
    def test_privatebroadcast(self):
        ...
        self.nodes[0].assert_start_raises_init_error(
            extra_args=["-privatebroadcast", "-connect=127.0.0.1:42003", "-onion=127.0.0.1:9050"],
            expected_msg=(
